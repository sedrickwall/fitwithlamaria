...
export function PuzzleKeyboard({ onKeyPress, onDelete, onEnter, letterStatus, disabled }: PuzzleKeyboardProps) {
  ...
  return (
    <div className="flex flex-col gap-2 w-full max-w-2xl mx-auto" data-testid="puzzle-keyboard">
        ...
        <div key={rowIndex} className="flex gap-2 justify-center">
          {rowIndex === 2 && (
            <button
              ...
              className="min-w-[80px] h-14 px-4 rounded-lg border-2 bg-primary text-primary-foreground border-primary font-semibold text-body-md disabled:opacity-50 focus:outline-none focus:ring-4 focus:ring-ring transition-all active:scale-95"
              aria-label="Enter"
            >
              ENTER
            </button>
          ...
          {row.map((letter) => (
            <button
              ...
              className={`
                min-w-[44px] h-14 px-3 rounded-lg border-2
          ...
          {rowIndex === 2 && (
            <button
              ...
              className="min-w-[80px] h-14 px-4 rounded-lg border-2 bg-secondary text-secondary-foreground border-border hover:bg-secondary/80 font-semibold text-body-md disabled:opacity-50 focus:outline-none focus:ring-4 focus:ring-ring transition-all active:scale-95 flex items-center justify-center gap-2"
              aria-label="Delete"
            >
